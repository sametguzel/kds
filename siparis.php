...
<td align=center colspan="5"> <font size=4 color=red face='Cursive'> <b> ÇALIŞAN LİSTESİ</b></td>
<br>
	<tr>
		<th bgcolor="#B39DDB"><i><font color=white>İD</th>
		<th bgcolor="#B39DDB"><i><font color=white>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ad Soyad&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
		<th bgcolor="#B39DDB"><i><font color=white>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Telefon&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
		<th bgcolor="#B39DDB"><i><font color=white>Çalıştığı Şube</th>
		<th bgcolor="#B39DDB"><i><font color=white>Cinsiyet</th>
	</tr>
<?php 
$baglanti=mysqli_connect("localhost","root","","samet");
$baglanti->set_charset("utf8");
$sql="SELECT calisanlar.calisan_id, calisanlar.calisan_ad, calisanlar.calisan_soyad,calisanlar.calisan_tel,subeler.sube_ad,cinsiyet.cinsiyet_ad
FROM calisanlar,subeler,cinsiyet
WHERE calisanlar.sube_id=subeler.sube_id AND calisanlar.cinsiyet_id=cinsiyet.cinsiyet_id  
ORDER BY calisanlar.calisan_id ASC";
$sorgu=mysqli_query($baglanti,$sql);
$a="TL";
while( $sonuc=mysqli_fetch_array($sorgu,MYSQLI_ASSOC) ){
	echo '<tr>';
	echo "<td align='center' bgcolor=#C5CAE9>"."<font face='Cursive'>".$sonuc["calisan_id"]."</td>";
	echo "<td align='center' bgcolor=#C5CAE9>"."<font face='Cursive'>".$sonuc["calisan_ad"]." ".$sonuc["calisan_soyad"]."</td>";
	echo "<td align='center' bgcolor=#C5CAE9>"."<font face='Cursive'>".$sonuc["calisan_tel"]."</td>";
