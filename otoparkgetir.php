...
if($baglanti){
    if ($_POST) {
        if(strip_tags(trim(isset($_POST["calisan_id"])))){
        ...
        $sorgu=mysqli_query($baglanti,"INSERT INTO calisanlar(calisan_id,calisan_ad,calisan_soyad,calisan_tel,sube_id,cinsiyet_id) VALUES
            ('".$calisan_id."','".$calisan_ad."','".$calisan_soyad."','".$calisan_tel."','".$sube_id."','".$cinsiyet_id."')");
        if ($sorgu==true) {
